...
def handle_message(event):
    with ApiClient(configuration) as api_client:
        ...
        # print("event 一個Line文字訊息的事件物件:", event)
        ...
        if user_msg in ["主選單", "選單", "menu"]:
            ...
            completion = client.chat.completions.create(
                model="gpt-4o-mini",
                messages=[
                    {"role": "system", "content": "你是一個充滿靈感的創作者，可以根據問題使用繁體中文提供有創造性的答覆"},
                    {
                        "role": "user",
                        "content": user_msg
                    }
        ...
        line_bot_api.reply_message_with_http_info(
            ReplyMessageRequest(
                ...
                messages=[
                    # 要回應的內容放在這個串列中
                    TextMessage(text="如需返回主選單可輸入menu"),
                    bot_msg,
        ...
        line_bot_api.reply_message_with_http_info(
            ReplyMessageRequest(
                ...
                messages=[
                    ...
                    TextMessage(text=f"貼圖包ID為 {package_id} ，貼圖ID為 {
                                sticker_id} 。"),
        ...
        line_bot_api.reply_message_with_http_info(
            ReplyMessageRequest(
                ...
                messages=[
                    ...
                    LocationMessage(title="Here is the location you sent.",
